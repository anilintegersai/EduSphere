...
""";
    ...
    private void RemoveDocumentModelState()
    {
        foreach (var key in ModelState.Keys.Where(k => k.StartsWith("DocumentInput.", StringComparison.Ordinal)).ToList())
